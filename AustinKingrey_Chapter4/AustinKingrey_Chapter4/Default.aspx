<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AustinKingrey_Chapter4.Default" %>
...
<div class="container-fluid">
  ...
  <main><form id="form1" runat="server">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <asp:Label ID="lblTotalPriceLabel" CssClass= runat="server" Text="Final Price"></asp:Label>
        <asp:Label ID="lblTotalPrice" runat="server" Text="Label"></asp:Label>
    </div>
      <%--a set of buttons, one to calculate, one to confirm and send to a second page.--%>
    <div class="btn-toolbar">
        <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Calculate" OnClick="Button1_Click" />
        <asp:Button ID="btnConfirm" runat="server" CssClass="btn" Text="Confirm" OnClick="btnConfirm_Click" BackColor="Lime" />
    </div>
    <div class="warning">
